...
function mapPartners(value: unknown): LandingContent["partners"] {
	...
	return {
		...
		...(row.heroTitle ? { heroTitle: localizedString(row.heroTitle, "landing_content.partners.heroTitle") } : {}),
		...(row.heroLead ? { heroLead: localizedString(row.heroLead, "landing_content.partners.heroLead") } : {}),
		...(row.heroCtaLabel ? { heroCtaLabel: localizedString(row.heroCtaLabel, "landing_content.partners.heroCtaLabel") } : {}),
